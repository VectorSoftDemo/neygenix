...
export default function Footer() {
  return (
    <footer className="bg-[#3a3a3a] text-white pt-10">
        ...
        <div className="flex flex-col lg:flex-row gap-10 pb-10">
          ...
          <div className="flex-1 space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <p className="text-2xl  xl:text-3xl font-bold text-[#65bc7b] leading-tight">
                  Neugenix<br />GLOBAL HEALTH
                </p>
                <p className="text-sm  xl:text-xl text-gray-300 font-light">
                  Understand more. Experience wellness.
                </p>
              </div>
            </div>

            <p className="text-lg  xl:text-2xl text-gray-200">
            ...
            <div>
              <p className="text-base  xl:text-2xl font-semibold text-gray-200">2225 Centennial Drive Gainesville, GA 30504</p>
              <p className="text-base  xl:text-2xl text-gray-200">Phone: <span className="text-[#65bc7b]">678-276-8412</span></p>
              <p className="text-base  xl:text-2xl text-gray-200">Email: <span className="text-[#65bc7b]">clientservices@Neugenix.com</span></p>
            </div>
      ...
      <div className="bg-[#3a3a3a] text-white text-center py-4 text-sm border-t border-gray-400 xl:text-2xl">
  ...
  return (
    <div className="flex items-start gap-4 bg-gray-200 bg-opacity-10 p-4 rounded">
      ...
      <div className="flex-1">
        <p className="text-base  xl:text-2xl font-semibold text-gray-800 mb-2">{title}</p>
        <p className="text-xs xl:text-xl text-gray-700 mb-2">{summary}</p>
        <button className="bg-[#2d2e83] hover:bg-[#1a1b5a] text-white text-xs  xl:text-xl px-3 py-1 rounded-2xl">
          Learn More
        </button>
      </div>
    </div>
