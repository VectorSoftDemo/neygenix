...
const AboutCoreValuesSection = () => (
    <section className="py-20 bg-[#EFEFEF] flex  justify-between">
        <div className="flex flex-col gap-4 p-8 pl-16">
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2">
                    ...
                    <p className="max-w-[80%]">At Nuegenix, we are committed to utilizing our expertise and knowledge to tackle worldwide challenges, enabling our communities to achieve their complete potential and establish the groundwork for advancement.</p>
                </div>
                <div className="flex flex-col gap-2">
                    <h2 className="font-semibold text-lg">Promoting Education</h2>
                    <p className="max-w-[80%]">Building a brighter future for people by providing them with access to high-quality educational opportunities represents a fundamental pillar of Nuegenix's corporate social responsibility efforts. From providing scholarships to students in Georgia's local communities to founding educational institutions in developing nations like Tajikistan, Nuegenix has led the way in creating new opportunities for young people.</p>
                </div>
        ...
        <div className="w-[400px]">
            <img src="	https://aeonglobalhealth.com/wp-content/uploads/2020/09/Layer-20.png" alt="Nuegenix Core Values" />
        </div>
    </section>
);
