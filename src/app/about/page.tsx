...
export default function AboutUs() { 
  ...
  return (
    <main className="min-h-screen mt-16 lg:mt-20 xl:mt-25">
      <section
      ...
      >
        ...
        <div className="flex flex-col justify-center items-center w-full relative z-10">
          <div className="flex flex-col h-full text-white w-full max-w-7xl gap-8">
            <h1 className="text-4xl xl:text-6xl font-bold text-left drop-shadow-lg text-[#144afc]">
              About Us
            </h1>
      ...
      <section className="bg- text-gray-800">
        ...
        <article className="py-8 w-full bg- ">
          <div className="flex flex-col justify-center items-center w-full px-4 sm:px-8">
            <div className=" flex flex-col justify-center items-center gap-4 max-w-full w-full">
              <h2 className="text-3xl sm:text-4xl lg:text-5xl xl:text-6xl font-bold text-[#144afc] text-center">
                Responsible Citizenship
              </h2>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl xl:text-3xl text-black leading-relaxed mt-4  ">
        ...
        <article className="max-w-7xl mx-auto py-10 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 text-[#144afc]">Our Mission</h2>
            ...
            {/* Our Identity Card */}
            <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 text-[#144afc]">Our Identity</h2>
              <p className="text-base sm:text-lg md:text-xl lg:text-2xl leading-relaxed">
        ...
        <article className="bg-white py-10 w-full">
          <article className="w-full max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex flex-col items-center text-center">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-6xl font-bold mb-2 sm:mb-3 text-[#144afc]">
                Our Core Values
              </h2>
              <p className="text-base sm:text-lg md:text-xl xl:text-3xl leading-relaxed mb-4 sm:mb-6">
              ...
              >
                <li className="bg-[#f1f5ff] rounded-2xl shadow p-5 flex flex-col items-center transition hover:shadow-lg">
                  <span className="font-semibold text-[#424492] text-base sm:text-lg xl:text-2xl text-center">
                    Integrity and ethical responsibility
                  </span>
                </li>
                <li className="bg-[#f1f5ff] rounded-2xl shadow p-5 flex flex-col items-center transition hover:shadow-lg">
                  <span className="font-semibold text-[#424492] text-base sm:text-lg text-center xl:text-2xl">
              ...
              {valueImages.map((img, idx) => (
                ...
                >
                  ...
                  <div className="mt-3 flex items-center justify-center">
                    <span className="bg-white/90 not-last:rounded-lg px-4 py-2 text-[#22641e] font-bold text-base sm:text-lg xl:text-3xl text-center  w-full truncate">
                      {img.title}
                    </span>
                  </div>
                </div>
      ...
      <section className="py-20 mx-10">
        <div className="w-full  gap-8 ">
          ...
          <div className="flex-1 flex flex-col gap-6 ml-15">
            <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-6xl font-bold mb-3 text-[#144afc] text-center">Our Future Outlook</h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Card 1 */}
              <div className="bg-white/90 rounded-xl shadow-md p-6 flex flex-col gap-2 border border-[#e5e7eb]">
                <h2 className="font-semibold text-lg sm:text-xl xl:text-4xl text-[#144afc]">
                  Welcoming Interns and Promoting Education
                </h2>
                <p className="text-gray-700 text-sm md:text-lg xl:text-3xl">
              ...
              {/* Card 2 */}
              <div className="bg-white/90 rounded-xl shadow-md p-6 flex flex-col gap-2 border border-[#e5e7eb]">
                <h2 className="font-semibold text-lg sm:text-xl  text-[#144afc] xl:text-4xl">
                  Promoting Education
                </h2>
                <p className="text-gray-700 text-sm md:text-lg xl:text-3xl">
              ...
              <div className="bg-white/90 rounded-xl shadow-md p-6 flex flex-col gap-3 border border-[#e5e7eb] col-span-1 md:col-span-2">
                <ul className="flex flex-col gap-6 pl-5">
                  <li>
                    <span className="font-semibold text-lg sm:text-xl text-[#144afc] xl:text-4xl">Endowment Fund at UGA</span>
                    <p className=" mt-1 text-gray-700 text-sm md:text-lg xl:text-3xl">
                  ...
                  <li>
                    <span className="font-semibold text-lg sm:text-xl text-[#144afc] xl:text-4xl">Scholarship for Medical Students from India</span>
                    <p className=" mt-1 text-gray-700 text-sm md:text-lg xl:text-3xl">
                  ...
                  <li>
                    <span className="font-semibold text-lg sm:text-xl text-[#144afc] xl:text-4xl">Supporting the Aga Khan Foundation USA</span>
                    <p className=" mt-1 text-gray-700 text-sm md:text-lg xl:text-3xl">
      ...
      <section className="bg-[#] flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-10  md:py-16">
        ...
        <div className="flex-1 flex flex-col gap-6 w-full mx-15">
          <div className="flex flex-col gap-3">
            <h1 className="font-semibold text-2xl sm:text-3xl md:text-4xl xl:text-5xl text-[#144afc] text-center md:text-left">
              Supporting Patients
            </h1>
            <p className="text-base sm:text-lg md:text-xl text-gray-900 text-center md:text-left xl:text-3xl">
          ...
          <div className="flex flex-col gap-3 max-w-full">
            <h2 className="font-semibold text-xl sm:text-2xl md:text-3xl text-[#144afc] text-center md:text-left xl:text-5xl">
              Patient Safety
            </h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-900 text-center md:text-left xl:text-3xl ">
