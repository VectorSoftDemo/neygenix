    ...
    return (
        <main className=" mt-16 lg:mt-20 xl:mt-25">
            ...
            <section>
                ...
                <article className="relative flex flex-col justify-center p-8 text-white w-full h-screen">
                    {/* Background Image */}
                    <Image
                    ...
                    <div className="relative z-10">
                        <h1 className="2xl:text-4xl font-semibold 2xl:pl-40 ">
                            <span className="font-bold text-6xl">Pharmacogenomics</span> – the Promise of Personalized Medicine
                        </h1>
                    </div>

                </article>

                <article className="flex flex-col items-center  py-8 px-2 sm:px-4 md:px-8 ">
                    <div className="grid grid-cols-1 md:grid-cols-2  gap-6 max-w-full">
                        {cardsData.map((card, index) => (
                            <div
                                key={index}
                                className="rounded-2xl shadow-lg p-5 sm:p-6 flex flex-col gap-3 sm:gap-4 transition-all duration-200 bg-gray-200"
                            >
                                <details className="group">
                                    <summary className="cursor-pointer text-base sm:text-lg md:text-xl lg:text-2xl xl:text-4xl font-semibold transition-colors list-none outline-none">
                                        <div>
                                            <div className="text-[#144afc]">{card.title}</div>
                                            <span className="p-2 mt-2 text-sm sm:text-base md:text-lg lg:text-2xl font-medium text-black/90">
                                                {card.short}
                                            </span>
                                            <span className="inline group-open:hidden text-green-800 ml-2 text-xs sm:text-sm lg:text-2xl">(Read more)</span>
                                            <span className="hidden group-open:inline text-green-800 ml-2 text-xs sm:text-sm lg:text-2xl">(Show less)</span>
                                        </div>
                                    </summary>
                                    <div className="mt-2 text-sm sm:text-base md:text-lg lg:text-2xl font-medium text-black/90">
                                        {card.remaining}
                                    </div>
                                </details>
                            </div>
                ...
                <article className="flex flex-col md:flex-row gap-8 mt-4 w-full items-center">
                    {/* The Testing Process */}
                    <div className="flex flex-col items-center gap-4 w-full md:w-1/3 rounded-2xl  p-4">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-center text-[#144afc]">
                            The Testing Process
                        </h1>
                    ...
                    <div className="flex flex-col items-center gap-4 w-full md:w-2/3 rounded-2xl  p-4 lg:p-8">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-bold text-center text-[#144afc]">
                            Impacted Medications and Genes Tested*
                        </h1>
                        <div className="w-full flex justify-center">
                ...
                {/* References */}
                <article className="flex flex-col items-center gap-4 mt-8 mx-24">
                    <h1 className="text-4xl font-bold text-center text-[#144afc]">References</h1>

                    <div className="w-full p-5">
                        <ol className=" w-full space-y-4 text-sm sm:text-base md:text-lg lg:text-2xl">
                            {[
                                `1. The Essentials of Diagnostics whitepaper. DX Insights. January 2012. National Center for Complementary and Integrative Health (NCCIH) and the Centers for Disease Control and Prevention (CDC), based on data from a special supplement—on use of complementary health approaches—to the 2012 National Health Interview Survey (NHIS).`
                            ].map((reference, idx) => (
                                <div
                                    key={idx}
                                    className="bg-white/80 rounded-md px-4 py-3 shadow-sm"
                                >
                                    <li className="list-item">
                                        <span className="block text-gray-800 leading-relaxed">{reference}</span>
                                    </li>
                                </div>
                            ))}
                        </ol>
            ...
            <section className="min-h-screen bg-[#]">
                ...
                <article className="relative flex flex-col justify-center p-8 text-white w-full min-h-screen">
                    <Image
                    ...
                    <div className="relative z-10 ml-10">
                        <h1 className="text-xl sm:text-2xl md:text-3xl 2xl:text-6xl font-semibold 2xl:pl-40">Toxicology Services</h1>
                        <p className="text-sm sm:text-base md:text-lg lg:text-3xl mt-2">
                ...
                <article className="flex flex-col md:flex-row gap-8 p-5 w-full items-center ">
                    {/* The Testing Process */}
                    <div className="flex flex-col items-center gap-4 w-full md:w-1/3 rounded-2xl p-4">
                    ...
                    <div className="flex flex-col items-center gap-6 w-full md:w-2/3 rounded-2xl p-4 lg:p-8">
                        <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-[#144afc]">
                            Tested Analytes Within Each Drug Class
                        </h1>
                        <div className="w-full flex justify-center bg-gray-200 p-8 rounded-2xl">
                            <img
                ...
                <article className="w-full flex flex-col items-center py-10 px-4 sm:px-6 md:px-10 lg:px-20 xl:px-30">
                    <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-[#144afc] w-full  mb-6 text-center">
                        References
                    </h2>
                    <ol
                        className="
                    ...
                    >
                        ...
                        <li className="pl-2">
                            <span className=" text-gray-800">
                                Pathan, Hasan, and John Williams. “Basic opioid pharmacology: an update.” <span className="italic">British journal of pain</span> vol. 6,1 (2012): 11-6.
                            </span>
                            <span className=" text-sm text-gray-600 break-all">doi:10.1177/2049463712438493</span>
                        </li>
                        <li className="pl-2">
                            <span className=" text-gray-800">
                                Mbughuni, Michael M et al. “Mass Spectrometry Applications for Toxicology.” <span className="italic">EJIFCC</span> vol. 27,4 272-287. 1 Dec. 2016
                            </span>
                        </li>
                        <li className="pl-2">
                            <span className=" text-gray-800">
                                Raouf, Mena et al. “A Practical Guide to Urine Drug Monitoring.” <span className="italic">Federal practitioner: for the health care professionals of the VA, DoD, and PHS</span> vol. 35,4 (2018): 38-44.
                            </span>
                        </li>
                        <li className="pl-2">
                            <span className=" text-gray-800">
                                Thomas G. Rosano, Patrice Y. Ohouo, Michelle Wood, Screening with Quantification for 64 Drugs and Metabolites in Human Urine using UPLC–MS-MS Analysis and a Threshold Accurate Calibration, <span className="italic">Journal of Analytical Toxicology</span>, Volume 41, Issue 6, July-August 2017, Pages 536–546,
                            </span>
                            <span className="block font-bold text-green-700 break-all">
