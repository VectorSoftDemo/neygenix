    ...
    <div className="min-h-screen">
      ...
      <div className="flex flex-wrap justify-center items-center p-8 bg-[#EFEFEF] mx-auto gap-2">
        <CareerItems
          ...
          title="INNOVATION"
          description="At Neugenix, we pioneer innovative healthcare technologies to enhance our operational excellence and create meaningful impact in patient care."
        ...
        <CareerItems
          ...
          description="At Neugenix, we provide outstanding client support through the utilization of sophisticated healthcare technologies to optimize our operations and elevate patient results."
          titleClass="text-[#424492] text-center text-2xl"
          descriptionClass="text-black text-center max-w-[400px] py-1"
          imageClass="w-[400px] h-[200px]"
        />
        <CareerItems
          ...
          title="INTEGRITY"
          description="At Neugenix, we maintain unwavering ethical principles while developing healthcare innovations to refine our methodologies and strengthen patient support."
          titleClass="text-[#424492] text-center text-2xl"
          descriptionClass="text-black text-center max-w-[400px] py-1"
          imageClass="w-[400px] h-[200px]"
        />
      ...
      <div className="flex justify-between items-center bg-[#EFEFEF] gap-4 py-8">
        <div className="flex flex-col  gap-4 p-8">
          ...
          <p className="text-base max-w-[80%]">
            Through our advanced testing solutions and cutting-edge methodologies, Neugenix has positioned itself as a market leader. Our extensive test offerings play a vital role in guiding the clinical decisions of healthcare professionals.
          </p>
        </div>
        <div className="">
          <img src="	https://aeonglobalhealth.com/wp-content/uploads/2020/09/Layer-20.png" alt="Neugenix" className="w-[180px] h-[300px]" />
        </div>
      </div>
      ...
      <div className="flex justify-center items-center text-center p-8 bg-[#46A941] text-white  gap-2">
        <div className="flex flex-col gap-4  max-w-[50%]">
          <p className="text-xl font-semibold">
            At Neugenix, we are dedicated to supporting individuals in achieving better and enhanced well-being. We create solutions to deliver insights that enable you to take control of your health journey.
          </p>
        </div>
      </div>
      <Curve innerColor="#46A941" outerColor="#EFEFEF" className="rotate-180" />
      ...
      <div className="flex justify-between items-center py-8 bg-[#EFEFEF]">
        <div className="flex justify-center items-center">
          <img src="https://aeonglobalhealth.com/wp-content/uploads/2020/09/Layer-20-Copy.png" alt="Neugenix" className="w-[170px] h-[300px]" />
        </div>
      ...
      <div className="flex justify-center items-center p-8 bg-[#EFEFEF] w-full">
        <div className="flex justify-between items-center ">
          ...
          <div className="pl-8">
            <img src="https://aeonglobalhealth.com/wp-content/uploads/2020/09/fullim-400x424.png" alt="Neugenix" className="w-[200px] h-[200px]" />
          </div>
        </div>
      </div>
