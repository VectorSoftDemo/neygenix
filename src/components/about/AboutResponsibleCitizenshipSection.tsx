    ...
    <section className=" pl-8 bg-[#EFEFEF] flex  gap-4 justify-between items-center pt-8">
        <div className="flex flex-col gap-4">
            <div className="flex flex-col gap-4">
                ...
                <p className="text-base">At Neugenix, we endeavor to constantly enhance our procedures and create meaningful improvements in our patients' lives.</p>
            </div>
            <div className="flex flex-col gap-4 max-w-[90%]">
                ...
                <p className="text-base pt-2">
                    Our methodology is patient-focused. For us, patient safety takes priority. Neugenix takes pride in guaranteeing quality, precision, and timeliness in reporting – our reports undergo multiple reviews before being delivered to physicians. We empower physicians to prescribe with assurance.</p>
            </div>
        </div>
        <div className="w-[200px] h-[400px]">
            <img src="https://aeonglobalhealth.com/wp-content/uploads/2020/09/Layer-20.png" alt="Neugenix Core Values" className="w-full h-full"/>
        </div>
    </section>
);
