...
export default function AboutUs() { 
  ...
  return (
    <main className="min-h-screen mt-10 lg:mt-18">
      ...
      >
        ...
        {/* Content */}
        <div className="flex flex-col justify-center items-center w-full relative z-10 px-3 sm:px-0">
          <div className="flex flex-col h-full text-white w-full max-w-7xl gap-8">
            <h1 className="text-3xl sm:text-4xl xl:text-6xl font-bold text-left drop-shadow-lg text-[#144afc]">
              About Us
            </h1>
            <p className="text-base sm:text-xl md:text-2xl text-left drop-shadow-lg max-w-md">
      ...
      <section className="text-gray-800">
        ...
        <article className="py-2 md:py-4 lg:py-6 w-full">
          <div className="flex flex-col justify-center items-center w-full px-4 sm:px-8">
            <div className="flex flex-col justify-center items-center gap-4 max-w-full w-full">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-bold text-[#144afc] text-center">
                Responsible Citizenship
              </h2>
              <p className="text-base sm:text-lg md:text-lg lg:text-xl xl:text-2xl text-black leading-relaxed md:mt-4">
        ...
        {/* Image Grid */}
        <article className="max-w-full mx-auto py-2 md:py-4 lg:py-6 px-4 sm:px-6 lg:px-8">
        ...
        {/* Mission Section */}
        <article className="max-w-7xl mx-auto py-2 px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-4 lg:gap-6">
            ...
            <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center">
              <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-3 text-[#144afc]">Our Mission</h2>
              <p className="text-sm text-left sm:text-lg md:text-lg lg:text-xl leading-relaxed">
            ...
            {/* Our Identity Card */}
            <div className="bg-white rounded-2xl shadow-md p-8 flex flex-col items-center text-center">
              <h2 className="text-xl sm:text-2xl lg:text-3xl xl:text-4xl font-bold mb-3 text-[#144afc]">Our Identity</h2>
              <p className="text-sm text-left sm:text-lg md:text-lg lg:text-xl leading-relaxed">
      ...
      <section className="bg-white py-10 w-full">
        <article className="w-full max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center text-center">
            <h2 className="text-xl lg:text-2xl xl:text-4xl font-bold mb-2 sm:mb-3 text-[#144afc]">
              Our Core Values
            </h2>
            <p className="text-base sm:text-lg md:text-lg xl:text-xl leading-relaxed mb-4 sm:mb-6">
            ...
            >
              <li className="bg-[#f1f5ff] rounded-2xl shadow p-5 flex flex-col items-center transition hover:shadow-lg">
                <span className="font-semibold text-[#424492] text-base sm:text-lg xl:text-lg text-center">
                  Integrity and ethical responsibility
                </span>
              </li>
              <li className="bg-[#f1f5ff] rounded-2xl shadow p-5 flex flex-col items-center transition hover:shadow-lg">
                <span className="font-semibold text-[#424492] text-base sm:text-lg text-center xl:text-lg">
            ...
            {valueImages.map((img, idx) => (
              ...
              >
                ...
                <div className="mt-3 flex items-center justify-center">
                  <span className="bg-white/90 not-last:rounded-lg px-4 py-2 text-[#22641e] font-bold text-sm sm:text-lg xl:text-xl text-center w-full truncate">
                    {img.title}
                  </span>
                </div>
              </div>
      ...
      <section className="py-2 md:py-4 lg:py-6 px-2 xs:px-4 sm:px-6 md:px-10 lg:px-16 xl:px-24">
        <div className="w-full flex flex-col gap-2">

          {/* Text Content */}
          <div className="flex-1 flex flex-col gap-2 md:py-4 lg:py-6">
            <h2 className="text-2xl sm:text-3xl lg:text-3xl xl:text-5xl font-bold mb-3 text-[#144afc] text-center">
              Our Future Outlook
            </h2>

            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {/* Card 1 */}
              <div className="bg-white/90 rounded-xl shadow-md p-4 xs:p-6 flex flex-col gap-2 border border-[#e5e7eb]">
                <h2 className="font-semibold text-base xs:text-lg sm:text-lg xl:text-2xl text-[#144afc]">
                  Welcoming Interns and Promoting Education
                </h2>
                <p className="text-gray-700 text-sm sm:text-base md:text-base xl:text-2xl">
              ...
              {/* Card 2 */}
              <div className="bg-white/90 rounded-xl shadow-md p-4 xs:p-6 flex flex-col gap-2 border border-[#e5e7eb]">
                <h2 className="font-semibold text-base xs:text-lg sm:text-lg text-[#144afc] xl:text-2xl">
                  Promoting Education
                </h2>
                <p className="text-gray-700 text-sm sm:text-base md:text-base xl:text-2xl">
              ...
              {/* Card 3 */}
              <div className="bg-white/90 rounded-xl shadow-md p-4 xs:p-6 flex flex-col gap-3 border border-[#e5e7eb] col-span-1 md:col-span-2">
                <ul className="flex flex-col gap-6 pl-2 xs:pl-5">
                  <li>
                    <span className="font-semibold text-base xs:text-lg sm:text-lg text-[#144afc] xl:text-2xl">
                      Endowment Fund at UGA
                    </span>
                    <p className="mt-1 text-gray-700 text-sm sm:text-base md:text-base xl:text-2xl">
      ...
      {/* <AboutVisionSection /> */}
      <article className="py-8 bg-white flex flex-col gap-4 justify-between items-center text-[#144afc] px-4 sm:px-6 md:px-8 lg:px-10">
        <div className="flex flex-col gap-4 w-full ">
          <h1 className="font-semibold text-2xl sm:text-4xl xl:text-5xl text-center">
            Welcoming Interns at Neugenix
          </h1>
          <p className="text-base sm:text-lg md:text-xl xl:text-2xl text-gray-700 text-left">
            Neugenix continuously strives to recruit a varied workforce. Diverse viewpoints and concepts are fostered and cultivated at Neugenix. Our robust internship initiative enables us to welcome numerous skilled and enthusiastic young professionals who collaborate closely with seasoned and proficient Neugenix staff members on high-priority projects. The interests of interns are carefully considered when assigning them to projects. We appreciate our interns, and many choose to remain as permanent members of the organization.
          </p>
        </div>
      </article>
      ...
      <section className="bg-[#] flex flex-col-reverse md:flex-row items-center justify-between gap-8 md:gap-10 py-2 md:py-4 lg:py-6">
        {/* Text Content */}
        <div className="flex-1 flex flex-col gap-6 w-full mx-15">
          <div className="flex flex-col gap-3">
            <h1 className="font-semibold text-xl sm:text-2xl md:text-3xl xl:text-4xl text-[#144afc] text-center md:text-left">
              Supporting Patients
            </h1>
            <p className="text-sm sm:text-base md:text-lg xl:text-2xl text-gray-900 text-left mx-2">
          ...
          <div className="flex flex-col gap-3 max-w-full">
            <h2 className="font-semibold text-xl sm:text-xl md:text-2xl xl:text-4xl text-[#144afc] text-center md:text-left">
              Patient Safety
            </h2>
            <p className="text-sm sm:text-base md:text-lg xl:text-2xl text-gray-900 text-left mx-2">
              We recognize that our work affects people's lives. We also comprehend that healthcare professionals rely on us to supply them with precise information, enabling them to make well-informed decisions regarding their patients. Our methodology is patient-focused. For us, patient safety takes priority. Neugenix takes pride in guaranteeing quality, precision, and timeliness in reporting – our reports undergo multiple reviews before being delivered to physicians. We empower physicians to prescribe with assurance.
            </p>
          </div>
        </div>
        {/* Image */}
